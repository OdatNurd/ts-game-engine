...
module nurdz.game.Collision
{
    ...
    export function pointInRect (pX : number, pY : number,
                                 rectX : number, rectY : number, width : number, height : number) : boolean
    {
                                   ...
                                   circleX : number, circleY : number, circleR : number) : boolean
    {
        ...
        return Utils.distanceBetweenXY (pX, pY, circleX, circleY) <= circleR;
    }
    ...
    export function rectInRect (rect1X : number, rect1Y : number, rect1W : number, rect1H : number,
                                rect2X : number, rect2Y : number, rect2W : number, rect2H : number) : boolean
    {
                                    ...
                                    circle2X : number, circle2Y : number, circle2R : number) : boolean
    {
        ...
        return Utils.distanceBetweenXY (circle1X, circle1Y, circle2X, circle2Y) <= circle1R + circle2R;
    }
