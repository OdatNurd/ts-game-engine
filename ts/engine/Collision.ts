module nurdz.game.Collision
{
     ...
     */
    export function segmentRectangleIntersection (p0 : Point, p1 : Point,
                                                  rectPos : Point, rectW : number, rectH : number,
                                                  result : Point = null) : Point
    {
        // Use the other method to do the hard work
        return this.segmentRectangleIntersectionXY (p0.x, p0.y, p1.x, p1.y,
                                                    rectPos.x, rectPos.y, rectW, rectH,
                                                    result);
    }
     ...
     */
    export function segmentRectangleIntersectionXY (x0 : number, y0 : number, x1 : number, y1 : number,
                                                    ...
                                                    result : Point = null) : Point
    {
        ...
        let collisions : Array<Point> = [];
        let intersect : Point = new Point (0, 0);

        // First, test the top of the rectangle.
        if (this.segmentIntersectionXY (x0, y0, x1, y1,
